...
def load_client(args, client_id, data, data_dir, message_pool, device):
    ...
    elif args.fl_algorithm == "ours":
        from openfgl.flcore.ours.client import OurClient
        return OurClient(args, client_id, data, data_dir, message_pool, device)
    elif args.fl_algorithm == "ourstwo":
        from openfgl.flcore.ourstwo.client import FedAvgClient
        return FedAvgClient(args, client_id, data, data_dir, message_pool, device)
    elif args.fl_algorithm == "FedLMC":
        from openfgl.flcore.FedLMC.client import FedLMClient
        return FedLMClient(args, client_id, data, data_dir, message_pool, device)
...
def load_server(args, global_data, data_dir, message_pool, device):
    ...
    if args.fl_algorithm == "isolate":
        ...
        from openfgl.flcore.ours.server import OursServer
        return OursServer(args, global_data, data_dir, message_pool, device)
    elif args.fl_algorithm == "ourstwo":
        from openfgl.flcore.ourstwo.server import FedAvgServer
        return FedAvgServer(args, global_data, data_dir, message_pool, device)
    elif args.fl_algorithm == "FedLMC":
        from openfgl.flcore.FedLMC.server import FedLMCServer
        return FedLMCServer(args, global_data, data_dir, message_pool, device)
